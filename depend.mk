...
OBJ_DIR_TREE += $(O_DIR)/srcs/strset/ $(O_DIR)/srcs/spanlist/ \
	...
	$(O_DIR)/libft/ft_in/ $(O_DIR)/libft/ft_getkey/ $(O_DIR)/libft/ft_file_in/ \
	$(O_DIR)/libft/ft_file/ $(O_DIR)/libft/ft_dstr/ $(O_DIR)/libft/ft_bst/ \
...
O_FILES += $(O_DIR)/srcs/editor/binding/cursor_move.o \
	...
	$(O_DIR)/srcs/editor/word_range.o $(O_DIR)/libft/ft_argv/arg.o \
...
sh21: $(O_DIR)/srcs/sh_parser/sh_parse_text.o \
	...
	$(O_DIR)/libft/ft_base/ft_bitset.o $(O_DIR)/srcs/sh_context/sh_function.o \
	$(O_DIR)/libft/ft_out/ft_write_char.o $(O_DIR)/srcs/editor/editor_write.o \
	$(O_DIR)/srcs/editor/binding/extra_mod.o \
	$(O_DIR)/libft/ft_term/term_out_flush.o $(O_DIR)/libft/ft_term/ft_tclear.o \
	$(O_DIR)/srcs/sh_default_builtins/builtins/false.o \
	$(O_DIR)/libft/ft_base/ft_wstrnconv.o $(O_DIR)/libft/ft_base/ft_subto.o \
	$(O_DIR)/libft/ft_bst/ft_bstdel.o $(O_DIR)/srcs/sh_ast/destroy_text.o \
	...
	$(O_DIR)/libft/ft_term/ft_tupdate.o $(O_DIR)/srcs/editor/text_index.o \
	$(O_DIR)/libft/ft_getkey/ft_getkey.o $(O_DIR)/libft/ft_base/ft_strlen.o \
	$(O_DIR)/srcs/sh_context/sh_path.o \
	$(O_DIR)/srcs/sh_default_builtins/builtins/pwd.o \
	$(O_DIR)/srcs/spanlist/ft_spanlist_iter.o \
	$(O_DIR)/srcs/sh_parser/sh_parse_text_comment.o \
	...
	$(O_DIR)/srcs/sh_parser/sh_parse_for_clause.o \
	$(O_DIR)/libft/ft_file_in/file_in.o $(O_DIR)/libft/ft_bst/ft_bstgetall.o \
	...
	$(O_DIR)/libft/ft_file/open.o $(O_DIR)/srcs/sh_context/sh_builtin.o \
	$(O_DIR)/libft/get_next_line/get_next_line.o \
	...
	$(O_DIR)/srcs/sh_ast/copy_compound.o $(O_DIR)/libft/ft_term/ft_tcursor.o \
	$(O_DIR)/srcs/sh_exec/sh_exec_cmd_for_clause.o \
	$(O_DIR)/srcs/sh_parser/sh_parse_if_clause.o \
	$(O_DIR)/srcs/editor/binding/delete.o $(O_DIR)/libft/ft_bst/ft_bstmin.o \
	$(O_DIR)/libft/ft_out/ft_putsub.o $(O_DIR)/libft/ft_set/get.o \
	$(O_DIR)/libft/ft_out/ft_putint.o $(O_DIR)/libft/ft_printf/ft_out.o \
	$(O_DIR)/libft/ft_file_in/file_in_open.o \
	$(O_DIR)/libft/ft_base/ft_getenv.o $(O_DIR)/libft/ft_out/ft_putfloat.o \
	...
	$(O_DIR)/srcs/sh_context/sh_env.o $(O_DIR)/libft/ft_bst/ft_bstput.o \
	$(O_DIR)/libft/ft_printf/exec_format.o $(O_DIR)/libft/ft_base/ft_sub.o \
	$(O_DIR)/libft/ft_base/ft_abs.o $(O_DIR)/libft/ft_base/ft_min.o \
	$(O_DIR)/srcs/sh_exec/sh_exec_compound.o \
	$(O_DIR)/srcs/spanlist/ft_spanlist_clear.o \
...
$(O_DIR)/libft/ft_lexer/build.o: libft/ft_lexer/build.c \
	libft/ft_base/public/libft.h libft/ft_dstr/public/ft_dstr.h \
	libft/ft_in/public/ft_in.h libft/ft_lexer/p_lexer.h \
