...
static t_binding const	g_bindings[] = {
	...
	BIND('m', MOD_CTRL,						editor_bind_write,			"\n",															0),
	BIND('i', MOD_CTRL,						editor_bind_write,			"\t",															0),

	BIND(KEY_BACKSPACE, 0,					editor_bind_delete,			V(CURSOR_MOVE_LEFT),											0),
	BIND(KEY_DELETE, 0,						editor_bind_delete,			V(0),															0),
	BIND(KEY_BACKSPACE, MOD_CTRL,			editor_bind_delete,			V(CURSOR_MOVE_WORD | CURSOR_MOVE_LEFT),							0),
	BIND(KEY_DELETE, MOD_CTRL,				editor_bind_delete,			V(CURSOR_MOVE_WORD),											0),
	BIND(KEY_BACKSPACE, MOD_ALT,			editor_bind_delete,			V(CURSOR_MOVE_SUBWORD | CURSOR_MOVE_LEFT),						0),
	BIND(KEY_DELETE, MOD_ALT,				editor_bind_delete,			V(CURSOR_MOVE_SUBWORD),											0),

	BIND(KEY_PAGEUP, 0,						editor_bind_cursor_move,	V(CURSOR_MOVE_BOUND | CURSOR_MOVE_LEFT),						0),
	BIND(KEY_PAGEDOWN, 0,					editor_bind_cursor_move,	V(CURSOR_MOVE_BOUND),											0),
	BIND(KEY_HOME, 0,						editor_bind_cursor_move,	V(CURSOR_MOVE_LINEBOUND | CURSOR_MOVE_LEFT),					0),
	BIND(KEY_END, 0,						editor_bind_cursor_move,	V(CURSOR_MOVE_LINEBOUND),										0),
	BIND('a', MOD_CTRL,						editor_bind_cursor_move,	V(CURSOR_MOVE_LINEBOUND | CURSOR_MOVE_LEFT),					0),
	BIND('e', MOD_CTRL,						editor_bind_cursor_move,	V(CURSOR_MOVE_LINEBOUND),										0),

	BIND('w', MOD_CTRL,						editor_bind_delete,			V(CURSOR_MOVE_LEFT | CURSOR_MOVE_WORD | DELETE_CLIPBOARD),		0),
	BIND('k', MOD_CTRL,						editor_bind_delete,			V(CURSOR_MOVE_LINEBOUND | DELETE_CLIPBOARD),					0),
	BIND('o', MOD_CTRL,						editor_bind_delete,			V(CURSOR_MOVE_LEFT | CURSOR_MOVE_LINEBOUND | DELETE_CLIPBOARD),	0),
	...
	BIND(KEY_UP, 0,							editor_bind_cursor_move,	V(CURSOR_MOVE_LINE | CURSOR_MOVE_LEFT),							0),
	BIND(KEY_DOWN, 0,						editor_bind_cursor_move,	V(CURSOR_MOVE_LINE),											0),
